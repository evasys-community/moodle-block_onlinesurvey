...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('block_onlinesurvey/connectiontype', get_string('communication_interface', 'block_onlinesurvey'),
    ...
    $settings->add(new admin_setting_configselect('block_onlinesurvey/useridentifier', get_string('useridentifier', 'block_onlinesurvey'),
    ...
    $settings->add(new admin_setting_configselect('block_onlinesurvey/customfieldnumber', get_string('customfieldnumberinevasys', 'block_onlinesurvey'),
    ...
    // Add SOAP heading.
    $settings->add(new admin_setting_heading('block_onlinesurvey/generalheadingsoap',
    ...
    // Add LTI heading.
    $settings->add(new admin_setting_heading('block_onlinesurvey/generalheadinglti',
